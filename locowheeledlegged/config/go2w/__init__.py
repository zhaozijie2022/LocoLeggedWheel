...
训练命令:
python locowheeledlegged/scripts/train.py --task Isaac-LocomotionGo2W-v1 --num_envs=4096 --headless

测试命令:
python locowheeledlegged/scripts/play.py --task Isaac-LocomotionGo2W-Play-v1 --num_envs=20 --load_run=xxxx --chekpoint=xxxx
